...
#define SHELL_BAN1      " /$$        /$$$$$$  /$$   /$$  /$$$$$$   /$$$$$$ "
#define SHELL_BAN2      "| $$       /$$__  $$| $$  | $$ /$$__  $$ /$$__  $$"
#define SHELL_BAN3      "| $$      | $$  \\__/| $$  | $$| $$  \\ $$| $$  \\ $$"
#define SHELL_BAN4      "| $$      | $$      | $$$$$$$$| $$  | $$| $$  | $$"
#define SHELL_BAN5      "| $$      | $$      | $$__  $$| $$  | $$| $$  | $$"
#define SHELL_BAN6      "| $$      | $$    $$| $$  | $$| $$  | $$| $$  | $$"
#define SHELL_BAN7      "| $$$$$$$$|  $$$$$$/| $$  | $$|  $$$$$$/|  $$$$$$/"
#define SHELL_BAN8      "|________/ \\______/ |__/  |__/ \\______/  \\______/ "
#define	SHELL_BAN9	"\033[0;39m\n"

/* Messages shell displays for user */

#define SHELL_PROMPT	"xsh $ "	/* Command prompt		*/
#define SHELL_STRTMSG	"Welcome to lchoo's XINU!\nChoo, Ley Yen (lchoo)\n"/* Welcome message*/
